...
abstract class Proximity extends Vector2 {
  factory Proximity()=>Proximity();
 ...
 *
 * @author davebaol */
abstract class ProximityCallback extends Vector2 {

  factory ProximityCallback()=>ProximityCallback();
